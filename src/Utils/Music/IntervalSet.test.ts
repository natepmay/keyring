...
test('shiftWithinSuperset', () => {
  const majorScale = IntervalSet.fromBinary(2741);
  const majorChord = IntervalSet.fromBinary(145);
  expect(majorChord.shiftWithinSuperset(majorScale, -1).binary).toBe(0b100000100100);
  expect(majorChord.shiftWithinSuperset(majorScale, 0).binary).toBe(145);
  expect(majorChord.shiftWithinSuperset(majorScale, 1).binary).toBe(0b001000100100);
  expect(majorChord.shiftWithinSuperset(majorScale, 2).binary).toBe(0b100010010000);
  expect(majorChord.shiftWithinSuperset(majorScale, 2).binary).toBe(0b100010010000);
  const minorChord = IntervalSet.fromBinary(137);
  expect(() => {minorChord.shiftWithinSuperset(majorScale, 1)}).toThrow();
})